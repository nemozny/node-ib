...
Outgoing.prototype.reqCompletedOrders = function(apiOnly) {
  if (this._controller._serverVersion < 76) {
    return this._controller.emitError('Version ' + this._controller._serverVersion + ' does not support reqCompletedOrders requests. You have to have TWS 976 and above.');
  }
